$(function() {
    ...
    // 1. Figure out how to make a single request to the Pokemon API to get names of URLs for every pokemon in the database.
    ...
    // 3. Start with your code from 2, but instead of logging the data on each randomn pokemon, store the name of the pokemon in a variable and then make another request, this time that pokemon's species URL.
    ...
    // 4. Create a UI for these random pokemon. Build an HTML page that lets you click on a button to generate data from three randomly chosen pokemon.
